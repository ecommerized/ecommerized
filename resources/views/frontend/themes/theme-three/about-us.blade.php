...
@section('content')
    ...
    @if(getOption('about_us_our_journey_status') == STATUS_ACTIVE)
        <section class="section-gap">
            ...
            <div class="swiper ourJourneySliderOne">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="journey-slide-img"><img src="{{ getFileUrl($aboutUs?->banner_image) }}" alt="" /></div>
                    </div>
                </div>
            </div>
        </section>
    ...
    <section class="section-gap bg-frame">
        <div class="container">
            ...
            <!--  -->
            <div class="aboutUs-wrap-two bg-white">
                <div class="item">
    ...
    <!-- About -->
    @if(getOption('about_us_our_mission_status') == STATUS_ACTIVE)
        <section class="section-gap">
            <div class="container">
                <div class="section-content-wrap pb-0">
                    <div class="text-center">
                        <p class="section-subtitle">
                            @php
                                $values = json_decode(landingPageSetting($collection,'about_us_details_our_mission_sub_title','[]'),true);
                            @endphp
                            @foreach($values as $index => $data)
                                <span>{{ strtoupper($data) }}</span>
                                @if($index < count($values) -1 )
                    ...
                    <h4 class="section-title text-center max-w-536 m-auto">{{ landingPageSetting($collection,'about_us_details_our_mission_title','') }}</h4>
                    <p class="section-info text-center text-para-text max-w-551 m-auto">{{landingPageSetting($collection,'about_us_details_our_mission_details','')}}</p>
                </div>
                <!--  -->
    ...
    @if(getOption('about_us_our_team_member_status') == STATUS_ACTIVE)
        <section class="section-gap-bottom bg-frame">
            <div class="container">
                <div class="section-content-wrap">
                    <div class="row rg-24 justify-content-md-between align-items-md-end">
                        <div class="col-lg-6">
