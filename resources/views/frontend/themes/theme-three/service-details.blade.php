                    ...
                    @foreach($serviceData->our_touch_point as $touchPoint)
                        <div class="col-lg-4 col-md-6">
                            <div class="touchpoint-item-one">
                                <div class="icon">
                                    <img src="{{ getFileUrl($touchPoint['icon']) }}" alt="{{ $touchPoint['title'] }}" />
                                </div>
                    ...
                    <div class="row rg-24">
                        ...
                        <div class="col-xxl-9 col-lg-8">
                            <div class="ourApproach-wrap max-w-892 text-center text-lg-start">
                                <p class="section-title-alt pt-0 text-white">{{ landingPageSetting($collection,'service_details_our_approach_title','') }}</span></p>
                ...
                <div class="row rg-24">
                    @foreach($chooseUs as $data)
                        <div class="col-lg-4 col-sm-6">
                            <div class="choose-item-two bg-bg sf-shadow">
                                <div class="icon"><img src="{{ getFileUrl($data->icon) }}" alt="" /></div>
                                <div class="text-content">
                                    <h4 class="title">{{ $data->title }}</h4>
