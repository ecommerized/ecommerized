...
@section('content')
    ...
    @if($ticketCount > 0)
        <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
            <!-- Tab - Create -->
            <div class="d-flex flex-column-reverse flex-xl-row justify-content-center justify-content-xl-between align-items-center align-items-xl-start flex-wrap g-20 table-pl">
                <!-- Left -->
                ...
                <div class="flex-grow-1 d-flex justify-content-center justify-content-sm-between justify-content-xl-end align-items-center flex-wrap g-12">
                    ...
                    <!--  -->
                    <a href="{{route('user.ticket.add-new')}}" class="border-0 bg-button py-8 px-26 bd-ra-8 fs-15 fw-600 lh-25 text-white">{{__("Create Ticket")}}</a>
                </div>
            </div>
            <!--  -->
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active ticketStatusTab" id="allTicket-tab-pane" role="tabpanel" aria-labelledby="allTicket-tab" tabindex="0">
                    <div class="bg-white bd-one bd-c-black-stroke bd-ra-10 p-sm-30 p-15">
    ...
    @else
        <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
            <div class="p-sm-30 p-15 bg-white bd-one bd-c-black-stroke bd-ra-10">
                <div class="create-wrap">
                    <div class="mb-22"><img src="{{ asset('assets/images/create-icon.png') }}" alt="" /></div>
                    <h4 class="pb-22 fs-24 fw-500 lh-30 text-title-text text-center">{{__("There is no tickets available here!")}}</h4>
                    <a href="{{route('user.ticket.add-new')}}" class="d-inline-flex bd-ra-8 bg-button py-10 px-26 fs-15 fw-600 lh-25 text-white">+{{__("Add Ticket")}}</a>
                </div>
            </div>
        </div>
    @endif
