                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action__buttons d-flex justify-content-end flex-wrap g-10">
                                            ...
                                            <button type="button"
                                                class="d-inline-block fs-15 fw-500 lh-25 text-white py-6 px-15 bg-title-text hover-bg-one border-0 bd-ra-8"
...
<div class="modal fade main-modal" id="helpModal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 bd-ra-4 p-sm-2 p-15">
...
<div class="modal fade" id="sendTestMail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 bd-ra-4 p-sm-2">
            ...
            <form method="POST" action="{{ route('admin.setting.mail.test') }}">
                ...
                <div class="modal-footer button__list">
                    <button type="button" class="border-0 fs-15 fw-500 lh-25 text-black py-10 px-26 bg-cdef84 bd-ra-12 hover-bg-one mx-2" data-bs-dismiss="modal">{{ __('Close') }}</button>
                    <button type="submit"
